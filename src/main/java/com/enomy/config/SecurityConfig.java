	...
	protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeRequests()
                    ...
                    .antMatchers(HttpMethod.GET, "/all_store").hasAnyRole("Client","Staff")
                    .antMatchers(HttpMethod.GET, "/new").hasAnyRole("Client","Staff")
                    .antMatchers(HttpMethod.GET,"/users").hasRole("Staff")
                    .antMatchers(HttpMethod.GET,"/delete").hasRole("Staff")
                    .antMatchers(HttpMethod.GET,"/edit").hasRole("Staff")
